        ...
        <div>
            <div>
                ...
                <div>
                    ...
                    {
                       className === '' ? '' : !routines === true &&  <h1 className="text-5xl text-center">No Routine Available</h1>
                    }
                    {
                        className === '' ? <h1  className="text-5xl text-center">Please Select Your Class</h1> :

                            !isLoading && routines && Object.keys(routines).length > 0 && (
                                <div className="space-y-10 border-2 p-4  mt-12  grid grid-cols-">
                                    {days.map(day => (
                                        <div className="flex gap-8 border-b-4" key={day}>
